            ...
            >
              <div className="text-center group">
                ...
                <motion.div
                  ...
                  className={`inline-flex items-center justify-center w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-xl sm:rounded-2xl bg-gradient-to-br ${step.color} shadow-lg sm:shadow-xl mb-4 sm:mb-6`}
                >
                ...
                {/* Connector Line (except last item) - Oculto en mobile */}
